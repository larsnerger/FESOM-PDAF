...
MODULE mod_obs_op_general_pdaf
!
! !DESCRIPTION:
...
! !ARGUMENTS:
    ...
    INTEGER, INTENT(in) :: id_obs_p_one(nobs_p_one) ! Index of current observations in PE-local state vector
...
! *********************************************
    ...
    DO i = 1, nobs_p_one
       m_state_p(i) = state_p(id_obs_p_one(i)) 
    ENDDO
...
END MODULE mod_obs_op_general_pdaf
